document.addEventListener('DOMContentLoaded', () => {
    ...
    const CHAD_RSS_SOURCES = [
        ...
        { url: 'https://www.rfi.fr/fr/tchad/rss', name: 'RFI Tchad' }
    ];
    ...
    const AFRICA_RSS_SOURCES = [
        ...
        { url: 'https://www.aljazeera.net/rss/behind-the-news/africa', name: 'الجزيرة - إفريقيا' }
    ];
    ...
    async function loadChadNews() {
        ...
        const results = await Promise.allSettled(CHAD_RSS_SOURCES.map(fetchOneFeed));
